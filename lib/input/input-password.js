...
var _default = _san["default"].defineComponent({
  dataTypes: _objectSpread({}, _base["default"].prototype.dataTypes, {
    type: _san.DataTypes.string,
    visibilityToggle: _san.DataTypes.bool
  }),
  components: {
  ...
  template: "\n        <span class=\"".concat(prefixCls, "-password ").concat(prefixCls, "-affix-wrapper\">\n            ").concat(_base["default"].prototype.template, "\n            <span class=\"").concat(prefixCls, "-suffix\" s-if=\"visibilityToggle\" on-click=\"handleEye\">\n                <s-icon type=\"eye{{type === 'password' ? '-invisible' : ''}}\" />\n            </span>\n        </span>\n    ")
}, _base["default"]);
