  ...
  _createClass(FieldsStore, [{
    ...
    value: function setFieldsInitialValue(initialValues) {
      ...
      Object.keys(flattenedInitialValues).forEach(function (name) {
        if (fieldsMeta[name]) {
          _this.setFieldMeta(name, _objectSpread(_objectSpread({}, _this.getFieldMeta(name)), {}, {
    ...
    value: function setFields(fields) {
      ...
      var nowFields = _objectSpread(_objectSpread({}, this.fields), fields);
      ...
      Object.keys(nowValues).forEach(function (f) {
        ...
        if (fieldMeta && fieldMeta.normalize) {
          ...
          if (nowValue !== value) {
            nowFields[f] = _objectSpread(_objectSpread({}, nowFields[f]), {}, {
              value: nowValue
            });
          }
        }
    ...
    value: function setFieldsAsDirty() {
      ...
      Object.keys(this.fields).forEach(function (name) {
        ...
        if (field && fieldMeta && (0, _utils.hasRules)(fieldMeta.validate)) {
          _this3.fields[name] = _objectSpread(_objectSpread({}, field), {}, {
            dirty: true
          });
        }
      });
    ...
    value: function getField(name) {
      return _objectSpread(_objectSpread({}, this.fields[name]), {}, {
        name: name
      });
    }
  }, {
