...
function _default() {
  ...
  return function (wrappedComponent) {
    return _san["default"].defineComponent(_objectSpread(_objectSpread({
      initData: function initData() {
        var wrappedComponentInitData = wrappedComponent.initData || noop;
        return _objectSpread(_objectSpread({}, wrappedComponentInitData.bind(this)()), {}, {
          submiting: false
        });
      }
    }, mixins), {}, {
      ...
      getFieldProps: function getFieldProps(name, options) {
        ...
        var meta = _objectSpread(_objectSpread(_objectSpread({}, fieldMeta), fieldOptions), {}, {
