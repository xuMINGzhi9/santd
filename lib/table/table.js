...
var _default = _san["default"].defineComponent({
  ...
  recursiveSort: function recursiveSort(data, sorterFn) {
    ...
    return data.sort(sorterFn).map(function (item) {
      return item[childrenColumnName] ? _objectSpread(_objectSpread({}, item), {}, _defineProperty({}, childrenColumnName, _this5.recursiveSort(item[childrenColumnName], sorterFn))) : item;
    });
  },
